...
Notice that this graph does not have little horizontal jags the way that the example image does in the
...
that every day has either full data or no data at all.

I'm going to choose the following strategy: any missing day will use the average of the day before and the day
